type WebsiteNotificationPreference = {
  id: string;
  label: string;
  description: string;
  enabled: boolean;
...
type WebsiteNotificationsProps = {
  preferences: WebsiteNotificationPreference[];
    ...
    <section className="rounded-2xl border border-forge-border bg-forge-card p-6 shadow-card">
      <div className="mb-6">
        ...
        <p className="mt-3 text-forge-silver">
          Control alerts shown inside your Astral Forge account dashboard and
          connected platform pages.
        </p>
      </div>
      ...
      {preferences.length === 0 ? (
        <div className="rounded-xl border border-forge-border bg-forge-dark p-6 text-center">
          <h3 className="text-lg font-semibold text-white">
            No Website Preferences Available
          </h3>

          <p className="mt-2 text-sm text-forge-silver">
            Website notification controls will appear here once available.
          </p>
        </div>
      ) : (
